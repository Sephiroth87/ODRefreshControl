...
ODRefreshControl is a "pull down to refresh" control for UITableView, like the one Apple introduced in iOS6, but available to anyone from iOS4 and up.
...
To know when the refresh operation has started, add and action method to the UIControlEventValueChanged event of the control
...
SVPullToRefresh is brought to you by "Fabio Ritrovato":http://orangeinaday.com and "contributors to the project":https://github.com/Sephiroth87/ODRefreshControl/contributors. If you have feature suggestions or bug reports, feel free to help out by sending pull requests or by "creating new issues":https://github.com/Sephiroth87/ODRefreshControl/issues/new. If you're using ODRefreshControl in your project, attribution would be nice. 